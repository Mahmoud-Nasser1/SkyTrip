    ...
    <Card className="cursor-pointer rounded-xl shadow-lg transition-transform duration-500 hover:scale-105 hover:shadow-xl">
      <CardBody>
        <div className="flex items-center container mx-auto">
          <div className="bg-gradient-main p-4 text-white rounded-xl text-3xl">
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <div className="w-full flex">
              ...
              <div className="flex items-center gap-3 w-1/2">
                <hr className="flex-grow h-2 border-0 rounded-full bg-gradient-to-r from-gradient-violet via-pink-500 to-orange-400 shadow-md" />
                ...
                <hr className="flex-grow h-2 border-0 rounded-full bg-gradient-to-r from-orange-400 via-pink-500 to-gradient-violet shadow-md" />
              </div>
