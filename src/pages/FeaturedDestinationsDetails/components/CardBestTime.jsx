const CardBestTime = ({ season, months, weather, icon }) => {
  return (
    <div className="flex flex-col items-center gap-4 p-5 bg-white duration-300 rounded-2xl shadow-md hover:shadow-lg transition-shadow w-64 dark:bg-dark-card hover:scale-[1.01] hover:border-gradient-violet hover:shadow-gradient-violet/30">
