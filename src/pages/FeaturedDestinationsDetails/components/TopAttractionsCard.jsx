const TopAttractionsCard = ({ image, name, description, entryPrice }) => {
  return (
    <div className="group cursor-pointer rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all transform duration-300 w-full sm:w-[48%] lg:w-[23%] dark:bg-dark-card hover:scale-[1.01] hover:border-gradient-violet hover:shadow-gradient-violet/30">
