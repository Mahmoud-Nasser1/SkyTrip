...
export function Card({ name, initials, feedback, image }) {
  ...
  hover:scale-[1.01] hover:border-gradient-violet dark:bg-dark-card"
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 className="text-gray-900 dark:text-gray-300 ">{name}</h3>
          <DefaultRating />
        </div>
      </div>

      <p className="text-gray-600 mt-4 text-sm leading-relaxed dark:text-gray-300">
        {feedback}
      </p>
    </div>
  );
