...
const LocationAndHours = () => {
  return (
    <div className="mb-6 backdrop-blur-xl bg-gradient-to-r from-gradient-sky/20 via-gradient-violet/20 to-gradient-peach/20 rounded-3xl p-8 shadow-lg border border-white/40 transition-all duration-500 hover:shadow-2xl hover:scale-[1] hover:border-gradient-violet/60">
